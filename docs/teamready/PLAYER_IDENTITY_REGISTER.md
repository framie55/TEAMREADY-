...
- **"Paul Griffith" (singular)** (`6a6e2dee326d3a4cb774fe3c`) — archived August 2026, noted as "a duplicate of Griffo." Briefly re-questioned 2026-09-09 after the FA list showed both spellings registered separately, but **Paul confirmed: leave as is, no further investigation** — there are definitively two Paul Griffiths (Griff, goalkeeper; Griffo, outfield), both correctly separate. Closed.
